...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{loop}\;(\Varid{f},\Varid{g})\mathrel{=}(\cdot \div \cdot \;((\mathrm{4}\mathbin{*}\Varid{g}\mathbin{+}\mathrm{2})\mathbin{*}\Varid{f})\;(\Varid{g}\mathbin{+}\mathrm{2}),\Varid{g}\mathbin{+}\mathrm{1}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{init}\mathrel{=}(\mathrm{1},\mathrm{0}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{prj}\mathrel{=}\p1{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\begin{figure}[h!]
  \centering
