...
\ensuremath{\begin{lcbr}\Varid{outExpAr}\comp \underline{\Conid{X}}\mathrel{=}i_1\\\Varid{outExpAr}\comp \Varid{numops}\mathrel{=}i_2\end{lcbr}}
\just\equiv{Aplicando definiçãos de ops e definição de numops}
\ensuremath{\begin{lcbr}\Varid{outExpAr}\comp \underline{\Conid{X}}\mathrel{=}i_1\\\Varid{outExpAr}\comp \alt{\Conid{N}}{\alt{\Conid{Bin}}{\uncurry{\Conid{Un}}}}\end{lcbr}\mathrel{=}i_2)}
...
\just\equiv{Aplicando Natural ID, Fusao+, Eq+ e Reflexão+}
  \left\{
    \begin{array}
      ...
      \ensuremath{\Varid{outExpAr}\comp \alt{\Conid{Bin}}{\uncurry{\Conid{Un}}}\mathrel{=}i_2\comp i_2}\\
      \end{array}
  \right.
...
\just\equiv{Aplicando de volta Natural ID, Fusão +, Eq+, Reflexão+ e ainda a igualdade extensional}
  \left\{
    \begin{array}
    \ensuremath{\Varid{outExpAr}\comp \underline{\Conid{X}}\mathrel{=}i_1\;()}\\
    \ensuremath{\Varid{outExpAr}\comp (\Conid{N}\;\Varid{a})\mathrel{=}i_2\comp i_1\mathbin{\$}}\\
    \ensuremath{\Varid{outExpAr}\;(\Conid{Un}\;\Varid{op}\;\Varid{b})\mathrel{=}i_2\comp i_2\comp i_2\mathbin{\$}(\Varid{op},\Varid{b})}\\
    \ensuremath{\Varid{outExpAr}\;(\Conid{Bin}\;\Varid{op}\;\Varid{c}\;\Varid{d})\mathrel{=}i_2\comp i_2\comp i_1\mathbin{\$}(\Varid{op},(\Varid{c},\Varid{d}))}\\
    \end{array}
  \right.
  \qed
\end{eqnarray}
...
\\
\>[B]{}\Varid{outExpAr}\;(\Conid{N}\;\Varid{a})\mathrel{=}i_2\comp i_1{}\<[26]%
\>[26]{}\mathbin{\$}\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{outExpAr}\;(\Conid{Un}\;\Varid{op}\;\Varid{b})\mathrel{=}i_2\;(i_2\;(i_2\mathbin{\$}(\Varid{op},\Varid{b}))){}\<[E]%
\\
\>[B]{}\Varid{outExpAr}\;(\Conid{Bin}\;\Varid{op}\;\Varid{c}\;\Varid{d})\mathrel{=}i_2\;(i_2\;(i_1\mathbin{\$}(\Varid{op},(\Varid{c},\Varid{d})))){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{baseExpAr1}\;\Varid{f}\;\Varid{g}\;\Varid{h}\;\Varid{j}\;\Varid{k}\;\Varid{l}\;\Varid{z}\mathrel{=}\Varid{f}+(\Varid{g}+(\Varid{h}\times(\Varid{j}\times\Varid{k})+\Varid{l}\times\Varid{z})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\newline
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mathbf{type}\;\Conid{OutExpAr1}\;\Varid{a}\mathrel{=}()+(\Varid{a}+((\Conid{BinOp},(\Conid{ExpAr}\;\Varid{a},\Conid{ExpAr}\;\Varid{a}))+(\Conid{UnOp},\Conid{ExpAr}\;\Varid{a}))){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\begin{eqnarray}
\start
recExpAr\ h = {\ensuremath{\Varid{id}\mathbin{+}(\Varid{id}\mathbin{+}(\Varid{id}\times(\Varid{h}\times\Varid{h})\mathbin{+}\Varid{id}\times\Varid{h})))}}
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{recExpAr}\;\Varid{h}\mathrel{=}\Varid{baseExpAr}\;\Varid{id}\;\Varid{id}\;\Varid{id}\;\Varid{h}\;\Varid{h}\;\Varid{id}\;\Varid{h}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\newpage
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{g\char95 eval\char95 exp}\;\Varid{a}\mathrel{=}\alt{\underline{\Varid{a}}}{\alt{\Varid{id}}{\alt{\Varid{expArit}}{\Varid{uNitar}}}}{}\<[E]%
\\
\>[B]{}\Varid{expArit}\;(\Conid{Sum},(\Varid{m},\Varid{o}))\mathrel{=}(\mathbin{+})\;\Varid{m}\;\Varid{o}{}\<[E]%
\\
\>[B]{}\Varid{expArit}\;(\Conid{Product},(\Varid{m},\Varid{o}))\mathrel{=}(\mathbin{*})\;\Varid{m}\;\Varid{o}{}\<[E]%
\\
\>[B]{}\Varid{uNitar}\;(\Conid{Negate},\Varid{a})\mathrel{=}\mathbin{-}\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{uNitar}\;(\Conid{E},\Varid{n})\mathrel{=}(\Varid{expd}\;\Varid{n}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{cat}\;\Varid{n}\mathrel{=}\Varid{prj}\comp \for{\Varid{loop}}\ {\Varid{init}}\mathbin{\$}\Varid{n}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{loop}\;(\Varid{c},\Varid{f},\Varid{g},\Varid{h})\mathrel{=}(\Varid{f}\mathbin{*}\Varid{c},\Varid{f}\mathbin{+}(\mathrm{6}\mathbin{/}\Varid{g}),\Varid{g}\mathbin{+}\Varid{h},\Varid{h}\mathbin{+}\mathrm{2}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{init}\mathrel{=}(\mathrm{1},\mathrm{1},\mathrm{6},\mathrm{6}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{prj}\;(\Varid{a},\Varid{b},\Varid{c},\Varid{d})\mathrel{=}\Varid{numerator}\;\Varid{a}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{h}\mathrel{=}\alt{\Varid{gCL1}}{\Varid{gCL2}}{}\<[E]%
\\
\>[B]{}\Varid{gCL1}\;()\mathrel{=}\underline{\Varid{nil}}{}\<[E]%
\\
\>[B]{}\Varid{gCL2}\;(\Varid{p},\Varid{x})\mathrel{=}(\overline{\Varid{g}}\;\Varid{p}\;\Varid{x})\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{8}{}\<[8]%
\>[8]{}\Varid{g}\;(\Varid{d},\Varid{f})\;\Varid{l}\mathrel{=}\mathbf{case}\;\Varid{l}\;\mathbf{of}{}\<[E]%
\\
\>[8]{}\hsindent{1}{}\<[9]%
\>[9]{}[\mskip1.5mu \mskip1.5mu]\to \Varid{nil}{}\<[E]%
\\
\>[8]{}\hsindent{1}{}\<[9]%
\>[9]{}(\Varid{x}\mathbin{:}\Varid{xs})\to \lambda \Varid{z}\to \Varid{concat}\mathbin{\$}(\Varid{sequenceA}\;[\mskip1.5mu \Varid{singl}\comp \Varid{linear1d}\;\Varid{d}\;\Varid{x},\Varid{f}\;\Varid{xs}\mskip1.5mu])\;\Varid{z}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{gCastel1}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}i_1\;\Varid{nil}{}\<[E]%
\\
\>[B]{}\Varid{gCastel1}\;[\mskip1.5mu \Varid{p}\mskip1.5mu]\mathrel{=}i_1\;\underline{\Varid{p}}{}\<[E]%
\\
\>[B]{}\Varid{gCastel1}\;\Varid{l}\mathrel{=}i_2\;(\Varid{init}\;\Varid{l},\Varid{tail}\;\Varid{l}){}\<[E]%
\\
\>[B]{}\Varid{gCastel2a}\;\Varid{l}\mathrel{=}\Varid{l}{}\<[E]%
\\
\>[B]{}\Varid{gCastel2b}\;(\Varid{x},\Varid{y})\mathrel{=}\lambda \Varid{pt}\to (\Varid{calcLine}\;(\Varid{x}\;\Varid{pt})\;(\Varid{y}\;\Varid{pt}))\;\Varid{pt}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{gCastel2}\mathrel{=}\alt{\Varid{gCastel2a}}{\Varid{gCastel2b}}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{deCasteljau}\mathbin{::}[\mskip1.5mu \Conid{NPoint}\mskip1.5mu]\to \Conid{OverTime}\;\Conid{NPoint}{}\<[E]%
\\
...
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{coalg}\mathrel{=}\llparenthesis\, \Varid{gCastel2}\,\rrparenthesis{}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{alg}\mathrel{=}\mathopen{[\!(}\Varid{gCastel1}\mathclose{)\!]}{}\<[E]%
\\
\>[B]{}\Varid{hyloAlgForm}\;\Varid{a}\;\Varid{b}\mathrel{=}{}\<[20]%
\>[20]{}\Varid{b}\comp \Varid{a}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{outLsingl}\;[\mskip1.5mu \Varid{a}\mskip1.5mu]\mathrel{=}i_1\;(\Varid{a}){}\<[E]%
\\
...
De seguida, assumimos que as funções \ensuremath{\Varid{avg}} e \ensuremath{\length } são dos seguintes tipos:
\\
...
Com isto, através das definições das funções anteriores e aos tipos de \ensuremath{\Varid{avg}} e \ensuremath{\length }, obtivemos o seguinte diagrama:
\\
...
{\xymatrix{
    A^{+}
          \ar[d]_-{\ensuremath{\mathbin{<}\Varid{avg},\length \mathbin{>}}}
                \ar[rr]^-{\ensuremath{\Varid{outLsingl}}} &
&   A + (A \times A^{+})
        \ar[d]^{\ensuremath{\Varid{recList}\;(\Varid{cataLsingl}\;([\mskip1.5mu \Varid{b},\Varid{q}\mskip1.5mu]))}}\\
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{b}\mathrel{=}\conj{\Varid{id}}{\underline{\mathrm{1}}}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{q}\mathrel{=}\conj{\Varid{auxFunc}}{\succ \comp \p2\comp \p2}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{30}{}\<[30]%
\>[30]{}\Varid{auxFunc}\;(\Varid{a},(\Varid{avg},\Varid{len}))\mathrel{=}((\Varid{a}\mathbin{+}(\Varid{avg}\mathbin{*}\Varid{len}))\mathbin{/}(\Varid{len}\mathbin{+}\mathrm{1})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
Como queremos a média de uma lista não vazia, vamos calcular este produto e aplicar de seguida a função \ensuremath{\p1}.
\\
...
\\[\blanklineskip]%
\>[B]{}\Varid{avg\char95 aux}\mathrel{=}\Varid{cataLsingl}\;\alt{\conj{\Varid{id}}{\underline{\mathrm{1}}}}{\conj{\Varid{auxFunc}}{\succ \comp \p2\comp \p2}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{60}{}\<[60]%
\>[60]{}\Varid{auxFunc}\;(\Varid{a},(\Varid{avg},\Varid{len}))\mathrel{=}((\Varid{a}\mathbin{+}(\Varid{avg}\mathbin{*}\Varid{len}))\mathbin{/}(\Varid{len}\mathbin{+}\mathrm{1})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks

Para árvores de tipo \LTree:

Mantendo os tipos das funções anteriores (\ensuremath{\Varid{avg}},\ensuremath{\Varid{len}}) e utilizando as funções já definidas (\ensuremath{\Varid{outLTree}},\ensuremath{\Varid{recLTree}},\ensuremath{\llparenthesis\, \cdot \,\rrparenthesis}) obtivemos o diagrama seguinte:\\
...
{\xymatrix{
    LTree A
          \ar[d]_-{\ensuremath{\mathbin{<}\Varid{avg},\length \mathbin{>}}}
                \ar[rr]^-{\ensuremath{\Varid{outLTree}}} &
&   A + (LTree A \times LTree A)
        \ar[d]^{\ensuremath{\Varid{recLTree}\;\llparenthesis\, [\mskip1.5mu \Varid{b},\Varid{q}\mskip1.5mu]\,\rrparenthesis}}\\
    A \times N_0 &  & A + ((A \times N_0) \times (A \times N_0))
          \ar[ll]^-{[b,q]}
}}
}
\\
Assim, temos os tipos das funções \ensuremath{\Varid{b}} e \ensuremath{\Varid{q}}.
\\
...
Para \ensuremath{\Varid{b}}, utilizamos a definição utilizada para a definição da função \ensuremath{\Varid{avg}} para listas não vazias:
\\
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{bLTree}\mathrel{=}\conj{\Varid{id}}{\underline{\mathrm{1}}}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\\

Para \ensuremath{\Varid{q}} temos que voltar a calcular a média das duas sub-árvores.
\\
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{23}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{qLTree}\mathrel{=}\conj{\Varid{auxFuncLTree}}{\Varid{sumSizes}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{23}{}\<[23]%
\>[23]{}\Varid{auxFuncLTree}\;((\Varid{a1},\Varid{n1}),(\Varid{a2},\Varid{n2}))\mathrel{=}(((\Varid{a1}\mathbin{*}\Varid{n1})\mathbin{+}(\Varid{a2}\mathbin{*}\Varid{n2}))\mathbin{/}(\Varid{n1}\mathbin{+}\Varid{n2})){}\<[E]%
\\
\>[B]{}\hsindent{23}{}\<[23]%
\>[23]{}\Varid{sumSizes}\;((\Varid{a1},\Varid{n1}),(\Varid{a2},\Varid{n2}))\mathrel{=}\Varid{n1}\mathbin{+}\Varid{n2}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks

\\
Com a função \ensuremath{\Varid{avgLTree}} vamos calcular o produto com a média e comprimento de uma árvore e utilizar a função p1 para retirar apenas a média.
Juntando as duas funções no \ensuremath{\alt{\cdot }{\cdot }} que será o gene do catamorfismo das LTrees, chegamos à definição da solução da função \ensuremath{\Varid{avgLTree}}:
...
\\
\>[B]{}\hsindent{25}{}\<[25]%
\>[25]{}\Varid{gene}\mathrel{=}\alt{\conj{\Varid{id}}{\underline{\mathrm{1}}}}{\conj{\Varid{auxFuncLTree}}{\Varid{sumSizes}}}\;\mathbf{where}{}\<[E]%
\\
\>[25]{}\hsindent{46}{}\<[71]%
\>[71]{}\Varid{auxFuncLTree}\;((\Varid{a1},\Varid{n1}),(\Varid{a2},\Varid{n2}))\mathrel{=}(((\Varid{a1}\mathbin{*}\Varid{n1})\mathbin{+}(\Varid{a2}\mathbin{*}\Varid{n2}))\mathbin{/}(\Varid{n1}\mathbin{+}\Varid{n2})){}\<[E]%
\\
\>[25]{}\hsindent{46}{}\<[71]%
\>[71]{}\Varid{sumSizes}\;((\Varid{a1},\Varid{n1}),(\Varid{a2},\Varid{n2}))\mathrel{=}\Varid{n1}\mathbin{+}\Varid{n2}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\begin{tabbing}\tt
~\char47{}\char47{}~\char40{}1\char41{}~Datatype~definition~\\
\tt ~type~BTree\char60{}\char39{}a\char39{}\char62{}~\char61{}\\
\tt ~~~~~~~\char124{}~Empty\\
\tt ~~~~~~~\char124{}~Node~of~a~\char42{}~of~BTree\char60{}\char39{}a\char62{}~\char42{}~BTree\char60{}\char39{}a\char62{}\\
\tt ~let~inBTree~x~\char61{}~either~\char40{}const~Empty\char41{}~Node~x\\
\tt ~let~outBTree~x~\char61{}\\
\tt ~~~~~match~x~width\\
\tt ~~~~~\char124{}~Empty~\char45{}\char62{}~left~\char40{}\char41{}\\
\tt ~~~~~\char124{}~Node~\char40{}a\char44{}t1\char44{}t2\char41{}~\char45{}\char62{}~Right~\char40{}a\char44{}t1\char44{}t2\char41{}\\
\tt ~\\
\tt ~\char47{}\char47{}2~Ana~\char43{}~cata~\char43{}~hylo\\
\tt ~let~baseBTree~g~f~\char61{}~g~\char45{}\char124{}\char45{}~\char40{}g~\char62{}\char60{}~\char40{}f~\char62{}\char60{}~f\char41{}\char41{}\\
\tt ~let~recBTree~f~\char61{}~baseBTree~id~f\\
\tt ~let~rec~cataBTree~g~\char61{}~g~\char60{}\char60{}~\char40{}recBTree~\char40{}cataBTree~g\char41{}\char41{}~\char60{}\char60{}~outBTree\\
\tt ~let~rec~anaBTree~g~\char61{}~inBTree~\char60{}\char60{}~\char40{}recBTree~\char40{}anaBTree~g\char41{}\char41{}~\char60{}\char60{}~g\\
\tt ~let~hyloBTree~h~g~\char61{}~cataBTree~h~\char60{}\char60{}~anaBTree~g\\
\tt ~\\
\tt ~\char47{}\char47{}3~Map\\
\tt ~let~fmap~f~\char61{}~cataBTree~\char40{}inBTree~\char60{}\char60{}~baseBTree~f~id\char41{}\\
\tt ~\\
\tt ~\char47{}\char47{}4\\
\tt ~\char47{}\char47{}4\char46{}1\\
\tt ~let~invBTree~x~\char61{}~cataBTree~\char40{}invLTree~\char60{}\char60{}~\char40{}id~\char45{}\char124{}\char45{}~id~\char62{}\char60{}~swap\char41{}\char41{}~x\\
\tt ~\char40{}\char42{}~Recall~the~pointwise~version\char58{}\\
\tt ~invBTree~\char40{}\char41{}~Empty\\
\tt ~invBTree~\char40{}Node~\char40{}a\char44{}\char40{}b\char44{}c\char41{}\char41{}\char41{}~\char61{}~Node\char40{}a\char44{}~\char40{}invBTree~c\char44{}~invBTree~b\char41{}\char41{}\\
\tt ~\char42{}\char41{}\\
\tt ~\\
\tt ~\char47{}\char47{}4\char46{}2\\
\tt ~let~countBTree~x~\char61{}~cataBTree~\char40{}either~\char40{}const~0\char41{}~\char40{}succ~\char46{}~\char40{}uncurry~\char40{}\char43{}\char41{}\char41{}~\char46{}~p2\char41{}\char41{}~x\\
\tt ~\\
\tt ~\char47{}\char47{}4\char46{}3~serialization\\
\tt ~let~inordt~x~\char61{}~cataBTree~inord~x\\
\tt ~let~inordt~x~\char61{}~either~nil~join~x\\
\tt ~~~~~where~join~\char40{}x\char44{}~\char40{}l\char44{}r\char41{}\char41{}~\char61{}~l~\char64{}~\char91{}x\char93{}~\char64{}~r\\
\tt ~let~preordt~x~\char61{}~cataBTree~preord\\
\tt ~let~preord~\char61{}~\char40{}either~nil~f\char41{}\\
\tt ~~~~~where~f\char40{}x\char44{}~\char40{}l\char44{}r\char41{}\char41{}~\char61{}~x\char58{}~l~\char64{}~r\\
\tt ~let~preord~\char61{}~cataBTree~\char40{}either~nil~f\char41{}\\
\tt ~~~~~where~f\char40{}x\char44{}~\char40{}l\char44{}r\char41{}\char41{}~\char61{}~x\char58{}~l~\char64{}~r~\char64{}~\char91{}x\char93{}\\
\tt ~\\
\tt ~\char47{}\char47{}4\char46{}4~quicksort\\
\tt ~let~qSort~\char61{}~hyloBTree~inord~qsep\\
\tt ~let~qsep~\char91{}\char93{}~\char61{}~Left~\char40{}\char41{}\\
\tt ~let~qsep~\char40{}h\char58{}t\char41{}~\char61{}~Right~\char40{}h\char44{}~\char40{}s\char44{}l\char41{}\char41{}\\
\tt ~~~~~where~\char40{}s\char44{}l\char41{}~\char61{}~part~\char40{}\char60{}h\char41{}~t\\
\tt ~let~part~p~\char91{}\char93{}~\char61{}~\char40{}\char91{}\char93{}\char44{}\char91{}\char93{}\char41{}\\
\tt ~let~part~p~\char40{}h\char58{}t\char41{}~\char124{}~p~h~\char61{}~let~\char40{}s\char44{}l\char41{}~\char61{}~part~p~t~in~\char40{}h\char58{}s\char44{}l\char41{}\\
\tt ~~~~~~~~~~~~~~~~~~\char124{}~otherwise~\char61{}~let~\char40{}s\char44{}l\char41{}~\char61{}~part~p~t~in~\char40{}s\char44{}~h\char58{}l\char41{}\\
\tt ~\\
\tt ~\char47{}\char47{}4\char46{}5~Traces\\
\tt ~let~traces~x~\char61{}~cataBTree~\char40{}either~\char40{}const\char91{}\char91{}\char93{}\char93{}\char41{}~tunion\char41{}~x\\
\tt ~let~tunion~\char40{}a\char44{}\char40{}l\char44{}r\char41{}\char41{}~\char61{}~union~\char40{}map~\char40{}a\char58{}\char41{}~l\char41{}~\char40{}map~\char40{}a\char58{}\char41{}~r\char41{}\\
\tt ~\\
\tt ~\char47{}\char47{}~\char40{}5\char41{}~Depth~and~balancing~\char40{}using~mutual~recursion\char41{}~\\
\tt ~balBTree~\char61{}~p1\char46{}baldepth\\
\tt ~depthBTree~\char61{}~p2\char46{}baldepth\\
\tt ~baldepth~\char61{}~cataBTree~g~where\\
\tt ~~~~~~g~\char61{}~either~\char40{}const\char40{}True\char44{}1\char41{}\char41{}~\char40{}h\char46{}\char40{}id\char62{}\char60{}f\char41{}\char41{}\\
\tt ~~~~~~h\char40{}a\char44{}\char40{}\char40{}b1\char44{}b2\char41{}\char44{}\char40{}d1\char44{}d2\char41{}\char41{}\char41{}~\char61{}~\char40{}b1~\char38{}\char38{}~b2~\char38{}\char38{}~abs\char40{}d1\char45{}d2\char41{}\char60{}\char61{}1\char44{}1\char43{}max~d1~d2\char41{}\\
\tt ~~~~~~f\char40{}\char40{}b1\char44{}d1\char41{}\char44{}\char40{}b2\char44{}d2\char41{}\char41{}~\char61{}~\char40{}\char40{}b1\char44{}b2\char41{}\char44{}\char40{}d1\char44{}d2\char41{}\char41{}\\
\tt ~\\
\tt ~\char47{}\char47{}~\char40{}6\char41{}~Going~polytipic~\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\\
\tt ~let~tnat~f~\char61{}~either~\char40{}const~mempty\char41{}~\char40{}theta~\char60{}\char60{}~\char40{}f~\char62{}\char60{}~theta\char41{}\char41{}\\
\tt ~~~~~~~where~theta~\char61{}~uncurry~mappend\\
\tt ~let~monBTree~f~\char61{}~cataBTree~\char40{}tnat~f\char41{}\\
\tt ~\char47{}\char47{}~alternative~to~\char40{}4\char46{}2\char41{}~serialization~\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\\
\tt ~let~preordt\char39{}~\char61{}~monBTree~singl\\
\tt ~\char47{}\char47{}~alternative~to~\char40{}4\char46{}1\char41{}~counting~\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\\
\tt ~countBTree\char39{}~\char61{}~monBTree~\char40{}const~\char40{}Sum~1\char41{}\char41{}\\
\tt ~\\
\tt ~\char47{}\char47{}~\char40{}7\char41{}~Zipper~\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\char45{}\\
\tt ~let~plug~\char91{}\char93{}~t~\char61{}~t\\
\tt ~let~plug~\char40{}\char40{}Dr~False~a~l\char41{}\char58{}z\char41{}~t~\char61{}~Node~\char40{}a\char44{}\char40{}plug~z~t\char44{}l\char41{}\char41{}\\
\tt ~let~plug~\char40{}\char40{}Dr~True~~a~r\char41{}\char58{}z\char41{}~t~\char61{}~Node~\char40{}a\char44{}\char40{}r\char44{}plug~z~t\char41{}\char41{}
\end{tabbing}
