...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{g\char95 eval\char95 exp}\;\Varid{n}\mathrel{=}\alt{\underline{\Varid{n}}}{\alt{\Varid{id}}{\alt{\Varid{expArit}}{\Varid{expoNega}}}}{}\<[E]%
\\
...
\\
\>[B]{}\Varid{expoNega}\;(\Conid{Negate},\Varid{n})\mathrel{=}\mathbin{-}\Varid{n}{}\<[E]%
\\
\>[B]{}\Varid{expoNega}\;(\Conid{E},\Varid{n})\mathrel{=}(\Varid{expd}\;\Varid{n}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{5}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{sd\char95 gen}\mathbin{::}\Conid{Floating}\;\Varid{f}\Rightarrow {}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}()+(\Varid{f}+((\Conid{BinOp},((\Conid{ExpAr}\;\Varid{f},\Conid{ExpAr}\;\Varid{f}),(\Conid{ExpAr}\;\Varid{f},\Conid{ExpAr}\;\Varid{f})))+(\Conid{UnOp},(\Conid{ExpAr}\;\Varid{f},\Conid{ExpAr}\;\Varid{f}))))\to (\Conid{ExpAr}\;\Varid{f},\Conid{ExpAr}\;\Varid{f}){}\<[E]%
\\
\>[B]{}\Varid{sd\char95 gen}\mathrel{=}\bot \mbox{\onelinecomment either f1 (either )    }{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\begin{eqnarray*}
  \xymatrix {
  \ensuremath{\Conid{A}\mathbin{\uparrow}\{\mskip1.5mu \mathbin{+}\mskip1.5mu\}}
     \ar[r]^{outLT}
     \ar[d]_{\llparenthesis length \rrparenthesis}
&
  \ensuremath{\Conid{A}\mathbin{+}\Conid{A}\lambda \Varid{times}\;\Conid{A}\mathbin{\uparrow}\{\mskip1.5mu \mathbin{+}\mskip1.5mu\}}
    \ar[d]^{id + id \times length}
\\
  \ensuremath{\N_0}
&
  \ensuremath{\Conid{A}\mathbin{+}\Conid{A}\lambda \Varid{times}\;\N_0}
...
\\
  \ensuremath{\N_0}
&
  \ensuremath{\Conid{A}\mathbin{+}\Conid{A}\lambda \Varid{times}\;(\Conid{R},\N_0)}
...
\column{15}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{avg\char95 aux}\;[\mskip1.5mu \Varid{x}\mskip1.5mu]\mathrel{=}(\Varid{x},\mathrm{1}){}\<[E]%
\\
\>[B]{}\Varid{avg\char95 aux}\;(\Varid{h}\mathbin{:}\Varid{t})\mathrel{=}((\Varid{h}\mathbin{+}(\Varid{a}\mathbin{*}\Varid{b}))\mathbin{/}(\succ \;\Varid{b}),\succ \;\Varid{b}){}\<[E]%
\\
\>[B]{}\hsindent{15}{}\<[15]%
\>[15]{}\mathbf{where}\;(\Varid{a},\Varid{b})\mathrel{=}\Varid{avg\char95 aux}\;\Varid{t}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
&
  \ensuremath{\Conid{A}\mathbin{+}(\mathsf{LTree}\;\Conid{A})\mathbin{\uparrow}\{\mskip1.5mu \mathrm{2}\mskip1.5mu\}}
    \ar[d]_{id + <avg, length>^{2}}
\\
  \ensuremath{\Conid{A}\lambda \Varid{times}\;\Conid{B}}
&
  \ensuremath{\Conid{A}\mathbin{+}(\Conid{X},\N_0)\lambda \Varid{times}\;(\Conid{X},\N_0)}
  }
\end{eqnarray*}
...
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{g}\;{}\<[7]%
\>[7]{}((\Varid{avgl},\Varid{ll}),(\Varid{avgr},\Varid{lr}))\mathrel{=}((\Varid{avgl}\mathbin{*}\Varid{ll})\mathbin{+}(\Varid{avgr}\mathbin{*}\Varid{lr}))\mathbin{/}(\Varid{ll}\mathbin{+}\Varid{lr}){}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\mbox{\onelinecomment  t = uncurry (+) . mulUnc >< mulUnc}{}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{gene}\mathrel{=}\alt{\conj{\Varid{id}}{\underline{\mathrm{1}}}}{\conj{\Varid{g}}{\uncurry{(\mathbin{+})}\comp (\p2\times\p2)}}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
